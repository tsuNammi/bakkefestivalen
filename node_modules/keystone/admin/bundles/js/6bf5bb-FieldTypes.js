...
module.exports = {
	...
	componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
		console.log('here we are', nextProps);
...
},{"../../../admin/client/App/elemental":64,"../../../admin/client/theme":79,"../Field":101,"./transparent-swatch":118,"glamor":undefined,"react":undefined,"react-color":undefined}],117:[function(require,module,exports){
'use strict';
	...
	renderFileNameAndChangeMessage: function renderFileNameAndChangeMessage() {
		...
		return _react2.default.createElement(
			...
			this.hasFile() && !this.state.removeExisting ? _react2.default.createElement(
				_FileChangeMessage2.default,
				{ component: href ? 'a' : 'span', href: href, target: '_blank' },
				this.getFilename()
			) : null,
